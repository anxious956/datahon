...
def main():
    ...
    fams={
      ...
      'gbm':(lambda:GradientBoostingRegressor(n_estimators=400,learning_rate=0.05,max_depth=3,subsample=0.8,random_state=4),X,Xt),
      'mlp1':(lambda:MLPRegressor((128,64),alpha=1e-3,max_iter=300,early_stopping=True,random_state=5),Xz,Xtz),
      'mlp2':(lambda:MLPRegressor((256,),alpha=3e-3,max_iter=300,early_stopping=True,random_state=6),Xz,Xtz),
